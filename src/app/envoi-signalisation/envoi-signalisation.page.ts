...
@Component({
  selector: 'app-envoi-signalisation',
  templateUrl: './envoi-signalisation.page.html',
  styleUrls: ['./envoi-signalisation.page.scss'],
})
export class EnvoiSignalisationPage implements OnInit {
